...
CREATE TABLE "scheduled_stations" ("id" INTEGER PRIMARY KEY  NOT NULL ,"scheduleid" INTEGER,"stationid" INTEGER,"duration" INTEGER,"runorder" INTEGER,"master" INTEGER DEFAULT (0) , "deleted" INTEGER DEFAULT 0);
INSERT INTO "scheduled_stations" VALUES(10001,10001,10001,500,1,0,0);
